...
!(function (a) {
  ...
  a.extend(a.fn.bootstrapTable.defaults, { showJumpto: !1, exportOptions: {} }),
  ...
  var c = a.fn.bootstrapTable.Constructor,
    d = c.prototype.initPagination;
  c.prototype.initPagination = function () {
    if (
      (d.apply(this, Array.prototype.slice.apply(arguments)),
      this.options.showJumpto)
    ) {
      var c = this,
        e = this.$pagination.find("ul.pagination"),
        f = e.find("li.jumpto");
      f.length ||
        ((f = a(
          [
        ...
        f.find("button").click(function () {
          c.selectPage(parseInt(f.find("input").val()));
        }));
    }
  };
})(jQuery);
