    ...
    if (this.options.groupBy && this.options.groupByField !== "") {
      if (this.options.sortName != this.options.groupByField) {
        this.data.sort(function (a, b) {
          return a[that.options.groupByField].localeCompare(
            b[that.options.groupByField]
          );
        });
      }
  ...
  BootstrapTable.prototype.initBody = function () {
    ...
    if (this.options.groupBy && this.options.groupByField !== "") {
      ...
      tableGroups.forEach(function (item) {
        ...
        that.$body
          .find("tr[data-parent-index=" + item.id + "]:first")
          .before($(html.join("")));
      });
      ...
      this.$body.find('[name="btSelectGroup"]').each(function () {
        ...
        that.$selectGroup.push({
          ...
          item: that.$selectItem.filter(function () {
            return (
              $(this).closest("tr").data("parent-index") ===
          ...
          that.$body
            .find(
              "tr[data-parent-index=" +
                $(this).closest("tr").data("group-index") +
                "]"
            )
            .toggleClass("hidden");
        });
      ...
      this.$container
        ...
        .on("click", '[name="btSelectGroup"]', function (event) {
          ...
          that[checked ? "checkGroup" : "uncheckGroup"](
            $(this).closest("tr").data("group-index")
          );
        });
    }
    ...
    if (!initBodyCaller) {
      ...
      if (this.options.groupBy && this.options.groupByField !== "") {
        this.$selectGroup.forEach(function (item) {
          var checkGroup =
            item.item.filter(":enabled").length ===
