!(function (e) {
  ...
  var p = (function () {
    ...
    h = (function () {
      ...
      function F(e, t) {
        ...
        if (
          ((n.options = F.extend({}, n.defaultOptions, a, null != t ? t : {})),
        ...
        return (
          ...
          null != n.options.renameFilename &&
            (n.options.renameFile = function (e) {
              return n.options.renameFilename.call(l(n), e.name, e);
            }),
              ...
              (this.prototype.Emitter = p),
                ...
                (this.prototype.defaultOptions = {
                  ...
                  fallback: function () {
                    ...
                    var t,
                      n = w(this.element.getElementsByTagName("div"));
                    try {
                      for (n.s(); !(t = n.n()).done; ) {
                        var i = t.value;
                  ...
                  addedfile: function (t) {
                    ...
                    if (
                      ...
                      (t.previewElement = F.createElement(
                      ...
                      try {
                        for (o.s(); !(a = o.n()).done; )
                          (r = a.value).innerHTML = this.filesize(t.size);
                      } catch (e) {
                        o.e(e);
                      } finally {
                        o.f();
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                return this.files
                  .filter(function (e) {
                    return e.status === F.UPLOADING || e.status === F.QUEUED;
                  })
                  .map(function (e) {
                    return e;
                  });
                ...
                if (
                  ...
                  !(function r() {
                    return (
                      ...
                      (null === a.options.maxFiles || 1 < a.options.maxFiles) &&
            ...
            },
            {
              ...
              value: function () {
                return (
                  ...
                  F.instances.splice(F.instances.indexOf(this), 1)
                );
              },
            },
            {
                  ...
                  try {
                    for (n.s(); !(e = n.n()).done; ) {
                      ...
                      null != r.webkitGetAsEntry && (i = r.webkitGetAsEntry())
                        ? i.isFile
                          ? t.push(o.addFile(r.getAsFile()))
                          : i.isDirectory
                          ? t.push(o._addFilesFromDirectory(i, i.name))
                          : t.push(void 0)
                        : null != r.getAsFile &&
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                e.size > 1024 * this.options.maxFilesize * 1024
                  ...
                  : F.isValidFile(e, this.options.acceptedFiles)
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (((e.status = F.QUEUED), this.options.autoProcessQueue))
                  return setTimeout(function () {
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  (e.status === F.UPLOADING && this.cancelUpload(e),
                ...
                (s.onload = function () {
                  (e.dataURL = s.result),
                    "image/svg+xml" !== e.type
                      ? o.createThumbnailFromUrl(e, t, n, i, r, a)
                      : null != a && a(s.result);
                }),
                  s.readAsDataURL(e);
              },
            ...
            },
            {
              ...
              value: function (e) {
                if (e.status === F.UPLOADING) {
                  ...
                  (e.status !== F.ADDED && e.status !== F.QUEUED) ||
                    ((e.status = F.CANCELED),
                ...
                this._transformFiles(l, function (e) {
                  if (u.options.chunking) {
                    ...
                    (l[0].upload.chunked =
                      ...
                      (l[0].upload.totalChunkCount = Math.ceil(
                        t.size / u.options.chunkSize
                      ));
                  }
              ...
              value: function (n, i) {
                function e(t) {
                  r.options.transformFile.call(r, n[t], function (e) {
                    (a[t] = e), ++o === n.length && i(a);
                  });
                }
                for (var r = this, a = [], o = 0, t = 0; t < n.length; t++)
                  e(t);
              },
            },
            {
    ...
    (h.discover = function () {
      ...
      return (function () {
        ...
        try {
          for (n.s(); !(e = n.n()).done; ) {
            var i = e.value;
            !1 !== h.optionsForElement(i) ? t.push(new h(i)) : t.push(void 0);
          }
        } catch (e) {
          n.e(e);
        } finally {
  ...
  var v = function (e, t, n, i, r, a, o, s, l, u) {
      var c = (function (e) {
        ...
        i.drawImage(e, 0, 0);
        for (
          var r = i.getImageData(1, 0, 1, t).data, a = 0, o = t, s = t;
          a < s;
            ...
            value: function (e) {
              ...
              for (
                ...
                (t =
                  ...
                  (i =
                    ((3 & a) << 6) | (o = this.KEY_STR.indexOf(e.charAt(s++)))),
                  l.push(t),
                  64 !== a && l.push(n),
                  64 !== o && l.push(i),
                  (t = n = i = ""),
  ...
  return (
    ...
    (function (t, n) {
      function i(e) {
        if ("readystatechange" !== e.type || "complete" === a.readyState)
          return (
