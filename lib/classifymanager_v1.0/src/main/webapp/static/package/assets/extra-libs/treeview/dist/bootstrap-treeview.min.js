!(function (a, b, c, d) {
  ...
  (g.prototype.init = function (b) {
          ...
          return (
            f.append(
              d.options.enableLinks
                ? a(d.template.link).attr("href", "javascript:alert("+e.categoryNo+");").append(e.categoryNm)
                : e.categoryNm
            ),
            d.options.showTags &&
              e.tags &&
    ...
    (g.prototype.css =
      ".treeview .list-group-item{cursor:pointer}.treeview span.indent{padding-left:5px;margin-left:10px;margin-right:10px}.treeview span.icon{width:12px;margin-right:5px}.treeview .node-disabled{color:silver;cursor:not-allowed}"),
