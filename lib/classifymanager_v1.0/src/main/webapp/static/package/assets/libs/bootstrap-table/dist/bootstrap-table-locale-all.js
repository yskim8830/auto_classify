...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["ar-SA"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "الظاهر " + pageFrom + " إلى " + pageTo + " من " + totalRows + " سجل"
      );
    },
    formatSearch: function () {
      return "بحث";
...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["da-DK"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "Viser " + pageFrom + " til " + pageTo + " af " + totalRows + " rækker"
      );
    },
    formatSearch: function () {
      return "Søg";
...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["fa-IR"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "نمایش " + pageFrom + " تا " + pageTo + " از " + totalRows + " ردیف"
      );
    },
    formatSearch: function () {
      return "جستجو";
...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["he-IL"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "מציג " + pageFrom + " עד " + pageTo + " מ-" + totalRows + " שורות"
      );
    },
    formatSearch: function () {
      return "חיפוש";
...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["sv-SE"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "Visa " + pageFrom + " till " + pageTo + " av " + totalRows + " rader"
      );
    },
    formatSearch: function () {
      return "Sök";
...
(function ($) {
  ...
  $.fn.bootstrapTable.locales["ur-PK"] = {
    ...
    formatShowingRows: function (pageFrom, pageTo, totalRows) {
      return (
        "دیکھیں " + pageFrom + " سے " + pageTo + " کے " + totalRows + "ریکارڈز"
      );
    },
    formatSearch: function () {
      return "تلاش";
