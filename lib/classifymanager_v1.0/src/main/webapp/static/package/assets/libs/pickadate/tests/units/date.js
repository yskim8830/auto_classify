...
test("Calendar stage", function () {
  strictEqual(
    this.picker.$root.find(
      "." + $.fn.pickadate.defaults.klass.table + " [data-pick]"
    ).length,
    42,
    "42 selectables dates"
  );
});
...
test("Properties", function () {
  ...
  strictEqual(
    picker.get("now").pick,
    today.getTime(),
    "Default “now” is " + picker.get("now", "yyyy/mm/dd")
  );
  deepEqual(picker.get("select"), null, "Default “select” is `null`");
  deepEqual(
    picker.get("highlight"),
    picker.get("now"),
    "Default “highlight” is “now”"
  );
  strictEqual(
    picker.get("view").pick,
    today.setDate(1),
    "Default “view” is " + picker.get("view", "yyyy/mm/dd")
  );
});
...
test("First weekday", function () {
  ...
  strictEqual(
    picker.$root
      .find("." + $.fn.pickadate.defaults.klass.weekdays)
      .first()
      .text(),
    $.fn.pickadate.defaults.weekdaysShort[0],
    "Sunday is first day"
  );
  ...
  strictEqual(
    $input
      .pickadate("picker")
      .$root.find("." + $.fn.pickadate.defaults.klass.weekdays)
      .first()
      .text(),
    $.fn.pickadate.defaults.weekdaysShort[1],
    "Monday is first day"
  );

  picker.set("select", [2013, 8, 14]);
  strictEqual(
    picker.$root.find("td").first().text(),
    "1",
    "Months starting on Sunday shift back a week"
  );
});
...
test("Formats", function () {
  ...
  today.setHours(0, 0, 0, 0);
  ["d", "dd", "ddd", "dddd", "m", "mm", "mmm", "mmmm", "yy", "yyyy"].forEach(
    function (format) {
      var expect = formats[format]();
      deepEqual(
        picker.get("now", format),
        expect,
        "`" + format + "`: " + expect
      );
    }
...
test("`select`", function () {
  ...
  deepEqual(
    picker.get("select").obj,
    playdate,
    "`select` using a number: " + playdate
  );
  strictEqual(
    picker.get("value"),
    picker.get("select", $.fn.pickadate.defaults.format),
    "`value` matches"
  );
  deepEqual(
    picker.get("highlight"),
  ...
  strictEqual(
    ...
    picker.get("highlight", "yyyy/mm/01"),
    "`view` updated"
  );
  ...
  deepEqual(
    picker.get("select").obj,
    playdate,
    "`select` using an array: " + playdate
  );
  strictEqual(
    picker.get("value"),
    picker.get("select", $.fn.pickadate.defaults.format),
  ...
  deepEqual(
    picker.get("select").obj,
    playdate,
    "`select` using a JS date object: " + playdate
  );
  strictEqual(
    picker.get("value"),
    picker.get("select", $.fn.pickadate.defaults.format),
...
test("`highlight`", function () {
  ...
  deepEqual(
    picker.get("highlight").obj,
    playdate,
    "`highlight` using a number: " + playdate
  );
  strictEqual(
    picker.get("view", "yyyy/mm/dd"),
    picker.get("highlight", "yyyy/mm/01"),
    "`view` updated: " + picker.get("view", "yyyy/mm/dd")
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  ...
  deepEqual(
    picker.get("highlight").obj,
    playdate,
    "`highlight` using an array: " + playdate
  );
  strictEqual(
    picker.get("view", "yyyy/mm/dd"),
    picker.get("highlight", "yyyy/mm/01"),
  ...
  deepEqual(
    picker.get("highlight").obj,
    playdate,
    "`highlight` using a JS date object: " + playdate
  );
  strictEqual(
    picker.get("view", "yyyy/mm/dd"),
    picker.get("highlight", "yyyy/mm/01"),
...
test("`view`", function () {
  ...
  deepEqual(
    picker.get("view").obj,
    playdate,
    "`view` using a JS date object: " + playdate
  );
  deepEqual(picker.get("highlight").obj, today, "`highlight` unaffected");
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
...
test("`min`", function () {
  ...
  deepEqual(
    picker.get("min").obj,
    playdate,
    "`min` using a negative number: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  deepEqual(
  ...
  deepEqual(
    picker.get("min").obj,
    playdate,
    "`min` using a positive number: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  ...
  deepEqual(
    picker.get("min").obj,
    playdate,
    "`min` using a JS date object: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  deepEqual(picker.get("highlight"), picker.get("min"), "`highlight` updated");
...
test("`max`", function () {
  ...
  deepEqual(
    picker.get("max").obj,
    playdate,
    "`max` using a positive number: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  deepEqual(
  ...
  deepEqual(
    picker.get("max").obj,
    playdate,
    "`max` using a negative number: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  ...
  deepEqual(
    picker.get("max").obj,
    playdate,
    "`max` using a JS date object: " + playdate
  );
  deepEqual(picker.get("now").obj, today, "`now` unaffected");
  deepEqual(picker.get("select"), null, "`select` unaffected");
  deepEqual(picker.get("highlight"), picker.get("max"), "`highlight` updated");
...
test("`disable` and `enable` using integers", function () {
  ...
  if (disableCollection.indexOf(today.getDay() + 1) > -1) {
    notDeepEqual(
      picker.get("highlight"),
      picker.get("now"),
      "Shifted disabled `highlight`: " + picker.get("highlight").obj
    );
  }
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Disabled dates added to collection"
  );

  $root.find("tr").each(function (indexRow, tableRow) {
    $(tableRow)
      .find("[data-pick]")
      .each(function (indexCell, tableCell) {
        if (disableCollection.indexOf(indexCell + 1) > -1) {
          ok(
            $(tableCell).hasClass($.fn.pickadate.defaults.klass.disabled),
            "Disabled as day of week: " +
              (indexCell + 1) +
              ". Date: " +
              tableCell.innerHTML
          );
  ...
  deepEqual(
    picker.get("disable"),
    [4, 7],
    "Disabled date removed from collection"
  );
  ...
  deepEqual(
    picker.get("disable"),
    [4, 7],
    "Disabled collection `enable` flipped"
  );
  ...
  deepEqual(
    picker.get("disable"),
    [4, 7],
    "Disabled collection `disable` flipped"
  );
...
test("`disable` and `enable` using arrays", function () {
  ...
  $root.find("td [data-pick]").each(function (indexCell, tableCell) {
    ...
    if (index === 1 || index === 17 || index === 25) {
      ok(
        $(tableCell).hasClass($.fn.pickadate.defaults.klass.disabled),
        "Date is disabled: " + tableCell.innerHTML
      );
    } else {
      ok(
        !$(tableCell).hasClass($.fn.pickadate.defaults.klass.disabled),
        "Date is enabled: " + tableCell.innerHTML
      );
    }
  });
...
test("`disable` and `enable` using JS dates", function () {
  ...
  deepEqual(
    picker.get("disable"),
    [new Date(nowYear, nowMonth, 1), new Date(nowYear, nowMonth, 25)],
    "Disabled date removed from collection"
  );
...
test("`disable` and `enable` using booleans", function () {
  ...
  strictEqual(
    $root.find("." + $.fn.pickadate.defaults.klass.disabled).length,
    0,
    "No dates disabled"
  );
...
test("`disable` and `enable` using ranges", function () {
  ...
  disableCollection = [
    { from: new Date(2014, 2, 7), to: new Date(2014, 2, 17) },
  ];
  picker.set("disable", disableCollection);
...
test("`disable` and `enable` using relative ranges", function () {
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Disabled range relative to today with date object"
  );
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Disabled range relative to today with array"
  );
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Disabled range relative to today with positive integer"
  );
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Disabled range relative to today with negative integer"
  );
...
test("`disable` and `enable` using overlapping ranges", function () {
  ...
  picker.set("disable", [{ from: [2014, 2, 4], to: [2014, 2, 28] }]);
  picker.set("enable", [{ from: [2014, 2, 14], to: [2014, 2, 18] }]);
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Inverted range within disabled range"
  );
  ...
  for (index = 0, datesCount = $dates.length; index < datesCount; index += 1) {
    disabledDate = +$dates[index].innerHTML;
    ok(
      (disabledDate >= 4 && disabledDate < 14) ||
  ...
  picker.set("disable", false);
  picker.set("disable", [{ from: [2014, 2, 4], to: [2014, 2, 28] }]);
  picker.set("enable", [{ from: [2014, 2, 1], to: [2014, 2, 14] }]);
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Inverted range before and within disabled range"
  );
  ...
  for (index = 0, datesCount = $dates.length; index < datesCount; index += 1) {
    disabledDate = +$dates[index].innerHTML;
    ok(
      disabledDate >= 14 && disabledDate <= 28,
      "Date is disabled: " + disabledDate
    );
  }

  picker.set("disable", false);
  picker.set("disable", [{ from: [2014, 2, 4], to: [2014, 2, 20] }]);
  picker.set("enable", [{ from: [2014, 2, 16], to: [2014, 2, 24] }]);
  ...
  deepEqual(
    picker.get("disable"),
    disableCollection,
    "Inverted range after and within disabled range"
  );
  ...
  for (index = 0, datesCount = $dates.length; index < datesCount; index += 1) {
    disabledDate = +$dates[index].innerHTML;
    ok(
      disabledDate >= 4 && disabledDate < 16,
      "Date is disabled: " + disabledDate
    );
  }
});
...
test("`disable` and `enable` repeatedly", function () {
  ...
  disabledCollection = [
    ...
    {
      from: [nowYear, nowMonth, 8],
      to: [nowYear, nowMonth, 12],
      inverted: true,
    },
  ];
  deepEqual(
    picker.get("disable"),
    disabledCollection,
    "Collection enabled various values"
  );
...
test("`select`", function () {
  ...
  deepEqual(
    picker.get("select"),
    picker.get("min"),
    "Able to not `select` beyond lower limit"
  );
  ...
  deepEqual(
    picker.get("select"),
    picker.get("max"),
    "Able to not `select` beyond upper limit"
  );
});
...
test("`highlight`", function () {
  ...
  deepEqual(
    picker.get("highlight"),
    picker.get("min"),
    "Able to not `highlight` beyond lower limit"
  );
  ...
  deepEqual(
    picker.get("highlight"),
    picker.get("max"),
    "Able to not `highlight` beyond upper limit"
  );
});
...
test("`view`", function () {
  ...
  deepEqual(
    [viewset.year, viewset.month, viewset.date],
    [min.year, min.month, 1],
    "Able to not `view` beyond lower limit"
  );
  ...
  deepEqual(
    [viewset.year, viewset.month, viewset.date],
    [max.year, max.month, 1],
    "Able to not `view` beyond upper limit"
  );
});
...
test("Select", function () {
  var picker = this.picker,
    ...
    monthEndDate = new Date(
      viewsetObject.year,
      viewsetObject.month + 1,
      0
    ).getDate();

  for (var i = monthStartDay; i < monthStartDay + monthEndDate; i += 1) {
    $root
      .find("." + $.fn.pickadate.defaults.klass.day)
      .eq(i)
      .click();
    strictEqual(
      ...
      new Date(
        viewsetObject.year,
        viewsetObject.month,
        viewsetObject.date + i - monthStartDay
      ).getTime(),
      "Selected " + picker.get("select", "yyyy/mm/dd")
    );
    strictEqual(
      picker.get("value"),
      picker.get("select", $.fn.pickadate.defaults.format),
      "Input value updated to " + picker.get("value")
    );
  }
});
...
test("Select", function () {
  ...
  for (var i = 0; i < 10; i += 1) {
    ...
    deepEqual(
      picker.get("select"),
      picker.get("highlight"),
      "Select updated to: " + picker.get("select").obj
    );
  }
});
...
test("Highlight", function () {
  ...
  for (var i = 0; i < 10; i += 1) {
    ...
    strictEqual(
      ...
      playdate.getDate(),
      'Keyed "down" to: ' + picker.get("highlight", "yyyy/mm/dd")
    );
    strictEqual(
      picker.get("view").month,
      picker.get("highlight").month,
      'Updated "view" to: ' + picker.get("view", "yyyy/mm/dd")
    );
  }
  ...
  for (var j = 0; j < 10; j += 1) {
    ...
    strictEqual(
      picker.get("highlight").date,
      playdate.getDate(),
      'Keyed "up" to: ' + picker.get("highlight", "yyyy/mm/dd")
    );
    strictEqual(
      picker.get("view").month,
      picker.get("highlight").month,
  ...
  for (var k = 0; k < 10; k += 1) {
    ...
    ok(
      picker.get("highlight").date === playdate.getDate() &&
        picker.get("highlight").day === playdate.getDay(),
      'Keyed "left" to: ' + picker.get("highlight", "yyyy/mm/dd")
    );
    strictEqual(
      picker.get("view").month,
      picker.get("highlight").month,
  ...
  for (var l = 0; l < 10; l += 1) {
    ...
    ok(
      picker.get("highlight").date === playdate.getDate() &&
        picker.get("highlight").day === playdate.getDay(),
      'Keyed "right" to: ' + picker.get("highlight", "yyyy/mm/dd")
    );
    strictEqual(
      picker.get("view").month,
      picker.get("highlight").month,
...
test('the pre-filled `value` selected is no longer "active"', function () {
  ...
  strictEqual(
    picker.get("valueSubmit"),
    "2014/08/14",
    "Sets the default value to submit"
  );
