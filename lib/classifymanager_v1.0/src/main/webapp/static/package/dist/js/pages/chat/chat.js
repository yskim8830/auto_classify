...
$(".message-type-box").on("keydown", function (event) {
  if (event.key === "Enter") {
    ...
    $messageHtml =
      '<li class="odd mt-4"> <div class="chat-content ps-3 d-inline-block text-end"> <div class="box mb-2 d-inline-block text-dark message font-weight-medium fs-3 bg-light-inverse">' +
      chatMessageValue +
    ...
    $(this).parents(".chat-application").find('.chat-box').scrollTop($(this).parents(".chat-application").find('.chat-box')[0].scrollHeight);
  }
});
