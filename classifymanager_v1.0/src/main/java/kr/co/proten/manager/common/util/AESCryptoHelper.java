 ...
 * 이 부분은 원 저작자의 해당 서비스에서 내려 받은 파일과 비교해 본 결과
...
public class AESCryptoHelper {
	...
	public static String encryptThisString(String input, String  userId )
    { 
        try { 
            // getInstance() method is called with algorithm SHA-512 
            MessageDigest md = MessageDigest.getInstance("SHA-512");
			input = input + "_" +  userId ;
	...
	public static void main( String[] args ){
		...
		System.out.println(AESCryptoHelper.encryptThisString("proten1!","promanager"));
		//System.out.println(AESCryptoHelper.decode("proten123!","SHA-512"));
	}
	*/
}
