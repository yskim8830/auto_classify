      ...
      function (e, t, n) {
        ...
        function a(e) {
          var t = r(),
            ...
            i = o.offsetParent(),
            a = 0;
          for (a = o.position().top; !i.is(n); )
            (o = i), (a += o.position().top), (i = o.offsetParent());
          return Math.floor(a);
        }
        function s(e, t) {
          if (
            ...
            .Deferred(function (e) {
              w.ajax({
                ...
                success: function (n, i, s) {
                  ...
                  f.toggleClass(
                    "with-summary",
                    w(".book").hasClass("with-summary")
                  ),
                    w(".book").replaceWith(f),
                    w(".book").attr("class", g),
                    w(".book-summary").scrollTop(m),
                    (j.state.$book = w(".book")),
                    p(!a),
                    a && o(a),
                    e.resolve();
        ...
        function f() {
          var e, t;
          (e = parseInt(w(".body-inner").css("width"), 10)),
            (t = parseInt(w(".page-wrapper").css("width"), 10)),
            w(".navigation-next").css("margin-right", e - t + "px");
          var n = r();
        ...
        function p(e) {
          ...
          var i = r();
          e !== !1 && i.scrollTop(0),
            (b = w(".book-summary .summary .chapter").filter(function () {
        ...
        function y() {
          w.ajaxSetup({ cache: !1 }),
            ...
            w(document).on("click", ".navigation-prev", g),
            w(document).on("click", ".navigation-next", g),
            w(document).on("click", ".summary [data-path] a", g),
            w(document).on("click", ".page-inner a", g),
            w(window).resize(f),
            p(!1);
        }
        var b,
