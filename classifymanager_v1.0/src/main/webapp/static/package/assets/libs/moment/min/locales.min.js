!(function (e, a) {
  ...
  e.defineLocale("ky", {
    ...
    e.defineLocale("lb", {
      ...
      relativeTime: {
        future: function (e) {
          return he(e.substr(0, e.indexOf(" "))) ? "a " + e : "an " + e;
        },
        past: function (e) {
          return he(e.substr(0, e.indexOf(" "))) ? "viru " + e : "virun " + e;
        },
        s: "e puer Sekonnen",
        ss: "%d Sekonnen",
        m: Ye,
  ...
  function De(e, a, _, s) {
    ...
    return 1 === e
      ? d + ce(0, a, _[0], s)
      : a
      ? d + (ke(e) ? pe(_)[1] : pe(_)[0])
      : s
      ? d + pe(_)[1]
      : d + (ke(e) ? pe(_)[1] : pe(_)[2]);
  }
  e.defineLocale("lt", {
    months: {
      format:
    ...
    translate: function (e, a, _) {
      ...
      return 1 === _.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + He.correctGrammaticalCase(e, s);
    },
  };
  function be(e, a, _, s) {
    switch (_) {
  ...
  var Ae = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
    Oe = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"),
    Fe = [
      /^jan/i,
      /^feb/i,
      /^maart|mrt.?$/i,
  ...
  e.defineLocale("nl-be", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? Oe[e.month()] : Ae[e.month()]) : Ae;
    },
    monthsRegex: ze,
    monthsShortRegex: ze,
    monthsStrictRegex:
  ...
  function $e(e, a, _) {
    ...
    switch (_) {
      case "ss":
        return s + (qe(e) ? "sekundy" : "sekund");
      case "m":
        return a ? "minuta" : "minut\u0119";
      case "mm":
        return s + (qe(e) ? "minuty" : "minut");
      case "h":
        return a ? "godzina" : "godzin\u0119";
      case "hh":
        return s + (qe(e) ? "godziny" : "godzin");
      case "MM":
        return s + (qe(e) ? "miesi\u0105ce" : "miesi\u0119cy");
      case "yy":
        return s + (qe(e) ? "lata" : "lat");
    }
  }
  function Ue(e, a, _) {
    var s = " ";
  ...
  var ea =
    ...
    aa = "jan_feb_mar_apr_m\xe1j_j\xfan_j\xfal_aug_sep_okt_nov_dec".split("_");
  function _a(e) {
    return 1 < e && e < 5;
  }
  function sa(e, a, _, s) {
    ...
    switch (_) {
      ...
      case "ss":
        return a || s ? d + (_a(e) ? "sekundy" : "sek\xfand") : d + "sekundami";
        break;
      case "m":
        return a ? "min\xfata" : s ? "min\xfatu" : "min\xfatou";
      case "mm":
        return a || s
          ? d + (_a(e) ? "min\xfaty" : "min\xfat")
          : d + "min\xfatami";
        break;
      case "h":
        return a ? "hodina" : s ? "hodinu" : "hodinou";
      case "hh":
        return a || s ? d + (_a(e) ? "hodiny" : "hod\xedn") : d + "hodinami";
        break;
      case "d":
        return a || s ? "de\u0148" : "d\u0148om";
      case "dd":
        return a || s ? d + (_a(e) ? "dni" : "dn\xed") : d + "d\u0148ami";
        break;
      case "M":
        return a || s ? "mesiac" : "mesiacom";
      case "MM":
        return a || s ? d + (_a(e) ? "mesiace" : "mesiacov") : d + "mesiacmi";
        break;
      case "y":
        return a || s ? "rok" : "rokom";
      case "yy":
        return a || s ? d + (_a(e) ? "roky" : "rokov") : d + "rokmi";
        break;
    }
  }
  function da(e, a, _, s) {
    ...
    translate: function (e, a, _) {
      ...
      return 1 === _.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + na.correctGrammaticalCase(e, s);
    },
  };
  e.defineLocale("sr", {
    months:
  ...
  var oa = "pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut".split(
    "_"
  );
  function ua(e, a, _, s) {
    var d = (function (e) {
    ...
    ordinal: function (e, a) {
      switch (a) {
        ...
        default:
          if (0 === e) return e + "'\u0131nc\u0131";
          var _ = e % 10;
          return e + (la[_] || la[(e % 100) - _] || la[100 <= e ? 100 : null]);
      }
    },
    week: { dow: 1, doy: 7 },
  }),
