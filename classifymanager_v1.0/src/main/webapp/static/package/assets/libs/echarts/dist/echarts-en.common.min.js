!(function (t, e) {
  ...
  function St(t, e) {
    Bp && bt(Bp, e), (Bp = Np.put(t, Bp || e.slice()));
  }
  function Mt(t, e) {
    if (t) {
      e = e || [];
      ...
      if (i in Rp) return bt(e, Rp[i]), St(t, e), e;
      if ("#" !== i.charAt(0)) {
        var r = i.indexOf("("),
          o = i.indexOf(")");
        if (-1 !== r && o + 1 === i.length) {
            ...
            if (0 !== i)
              if (((I = (e - m[n]) / i), l))
                if (
                  ...
                  Ft(C, T, D, A, I, I * I, I * I * I, a(t, r), g);
                else {
                  if (f)
                    (o = Ft(C, T, D, A, I, I * I, I * I * I, L, 1)),
                      (o = Wt(L));
                  else {
                    if (p) return Rt(T, D, I);
        ...
        if ("string" == typeof b && "%" === b.charAt(b.length - 1))
          ...
          null != A &&
            ...
            (!S || A < C
              ...
              : ((P.text = ve(P.text, A - C, _, c.ellipsis, {
                  minChar: c.minChar,
                })),
                (P.textWidth = ue(P.text, _)),
                (b = P.textWidth + C)));
    ...
    for (var x = 0; x < n.lines.length; x++) {
      for (
        var _,
          ...
          D = y,
          A = S - 1;
        C < S && (!(_ = b[C]).textAlign || "left" === _.textAlign);

      )
        Ee(t, e, _, i, M, v, T, "left"), (I -= _.width), (T += _.width), C++;
      for (; A >= 0 && "right" === (_ = b[A]).textAlign; )
        Ee(t, e, _, i, M, v, D, "right"), (I -= _.width), (D -= _.width), A--;
      for (T += (o - (T - m) - (y - D) - I) / 2; C <= A; )
        Ee(t, e, (_ = b[C]), i, M, v, T + _.width / 2, "center"),
          (T += _.width),
          C++;
      v += M;
    }
  ...
  function Ne(t, e, n, i, r, o, a) {
    ...
    if (
      ...
      c ? Te(e, { x: i, y: r, width: o, height: a, r: c }) : e.rect(i, r, o, a),
        e.closePath();
    }
  ...
  function on(t, e, n) {
    Tg ? t.addEventListener(e, n) : t.attachEvent("on" + e, n);
  }
  function an(t, e, n) {
    Tg ? t.removeEventListener(e, n) : t.detachEvent("on" + e, n);
  }
  function sn(t) {
    return t.which > 1;
  }
  ...
  function hi(t, e, n, i, r, o, a, s, l) {
    ...
    if (Math.abs(i - r) % Nm < 1e-4) return !0;
    if (o) {
      var c = i;
      (i = li(r)), (r = li(c));
    } else (i = li(i)), (r = li(r));
    ...
    return (
      d < 0 && (d += Nm), (d >= i && d <= r) || (d + Nm >= i && d + Nm <= r)
    );
  }
  ...
  function zi(t) {
    var e = t.shape,
      n = t.style.lineWidth;
    return (
      Iv(2 * e.x1) === Iv(2 * e.x2) && (e.x1 = e.x2 = Ri(e.x1, n, !0)),
      Iv(2 * e.y1) === Iv(2 * e.y2) && (e.y1 = e.y2 = Ri(e.y1, n, !0)),
      t
    );
  }
  function Ei(t) {
    ...
    return (
      (e.x = Ri(e.x, n, !0)),
      (e.y = Ri(e.y, n, !0)),
      (e.width = Math.max(Ri(i + o, n, !1) - e.x, 0 === o ? 0 : 1)),
      (e.height = Math.max(Ri(r + a, n, !1) - e.y, 0 === a ? 0 : 1)),
      t
    );
  }
  function Ri(t, e, n) {
  ...
  function Bi(t) {
    return "string" == typeof t ? Tt(t, -0.1) : t;
  }
  function Vi(t) {
    if (t.__hoverStlDirty) {
      var e = t.style.stroke,
        n = t.style.fill,
        i = t.__hoverStl;
      (i.fill = i.fill || (Ni(n) ? Bi(n) : null)),
        (i.stroke = i.stroke || (Ni(e) ? Bi(e) : null));
      var r = {};
  ...
  function $i(t, e, n, i, r, o, a) {
    ...
    var f = c ? s : null,
      p = d
        ? T(l ? l.getFormattedLabel(h, "emphasis", null, u) : null, s)
        : null;
  ...
  function hr(t, e, n) {
    return (
      e && !c(e) && (e = Tp.getLocalTransform(e)),
      n && (e = ct([], e)),
      $([], t, e)
    );
  }
  ...
  function dr(t, e) {
    return f(t, function (t) {
      var n = t[0];
      (n = Cv(n, e.x)), (n = Tv(n, e.x + e.width));
      var i = t[1];
      return (i = Cv(i, e.y)), (i = Tv(i, e.y + e.height)), [n, i];
    });
  }
  function fr(t, e, n) {
  ...
  function Da(t, e, i) {
    ...
    te(Ax, r),
      te(Cx, r),
      (this._scheduler = new ca(this, a, Cx, Ax)),
      xp.call(this),
      (this._messageCenter = new Ta()),
      this._initEvents(),
  ...
  function Is(t, e, i) {
    ...
    for (var M = x || "value", I = 0; I < f; I++)
      null == (v = c[I] = c[I] || {}).coordDim &&
        ...
        b--),
        null == v.name && (v.name = Ts(v.coordDim, h)),
  ...
  function nh(t, e, n) {
    ...
    if (C(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
      var r = e.getModel("axisLabel"),
        ...
        l = ((C(n.labelRotate, r.get("rotate")) || 0) * mw) / 180,
  ...
  function mh(t, e, n) {
    ...
    (o.labelDirection = o.tickDirection = o.nameDirection = m[a]),
      ...
      C(n.labelInside, e.get("axisLabel.inside")) &&
  ...
  function Nu(t, e) {
    ...
    if (e && !Eu(e) && !y(e.coord) && r) {
      var o = r.dimensions,
        a = Bu(e, i, r, t);
      if ((e = n(e)).type && Cb[e.type] && a.baseAxis && a.valueAxis) {
        var s = Mb(o, a.baseAxis.dim),
          l = Mb(o, a.valueAxis.dim);
        (e.coord = Cb[e.type](i, a.baseDataDim, a.valueDataDim, s, l)),
          (e.value = e.coord[l]);
      } else {
        for (
          var h = [
          ...
          Cb[h[u]] && (h[u] = Gu(i, i.mapDimension(o[u]), h[u]));
        e.coord = h;
      }
    }
    return e;
  ...
  function Pc(t) {
    if (
      !sn(t) &&
      Rc(this, "moveOnMouseMove", t) &&
      this._dragging &&
      "pinch" !== t.gestureEvent &&
      !Tc(this._zr, "globalPan")
    ) {
      var e = t.offsetX,
        n = t.offsetY,
        i = this._x,
  ...
  function Oc(t) {
    if (Rc(this, "zoomOnMouseWheel", t) && 0 !== t.wheelDelta) {
      var e = t.wheelDelta > 0 ? 1.1 : 1 / 1.1;
      Ec.call(this, t, e, t.offsetX, t.offsetY);
    }
  }
  function zc(t) {
    if (!Tc(this._zr, "globalPan")) {
  ...
  function Gd(t, e, i, r) {
    ...
    if ((t._track.push(i.slice()), Md(t) || a)) {
      ...
      if (a) {
        ...
        (a.__brushOption.range = u.getCreatingRange(Nd(t, a, t._track))),
  ...
  function Kd(t, e, n) {
    var i = (this._targetInfoList = []),
      ...
      o = Jd(e, t);
    RS(GS, function (t, e) {
      (!n || !n.include || NS(n.include, e) >= 0) && t(o, i, r);
    });
  }
  function Qd(t) {
  ...
  function If(t, e) {
    e && Cf(t, "transform", "matrix(" + HM.call(e, ",") + ")");
  }
  function Cf(t, e, n) {
    ...
    if (Sf(e, n)) {
      ...
      (i = "transparent" === i ? GM : i),
        "none" !== t.getAttribute("clip-path") &&
          ...
          (i = "rgba(0, 0, 0, 0.002)"),
        Cf(t, "fill", i),
        Cf(t, "fill-opacity", e.opacity);
    } else Cf(t, "fill", GM);
    if (Mf(e, n)) {
      var r = n ? e.textStroke : e.stroke;
      Cf(t, "stroke", (r = "transparent" === r ? GM : r)),
        Cf(
          t,
          "stroke-width",
        ...
        Cf(t, "paint-order", n ? "stroke" : "fill"),
        Cf(t, "stroke-opacity", e.opacity),
        e.lineDash
          ? (Cf(t, "stroke-dasharray", e.lineDash.join(",")),
            Cf(t, "stroke-dashoffset", WM(e.lineDashOffset || 0)))
          : Cf(t, "stroke-dasharray", ""),
        e.lineCap && Cf(t, "stroke-linecap", e.lineCap),
        e.lineJoin && Cf(t, "stroke-linejoin", e.lineJoin),
        e.miterLimit && Cf(t, "stroke-miterlimit", e.miterLimit);
    } else Cf(t, "stroke", GM);
  }
  function Af(t) {
  ...
  (Dp.transform = null),
    ...
    (Dp.getLocalTransform = function (t) {
      return Tp.getLocalTransform(this, t);
    }),
  ...
  (Dp.decomposeTransform = function () {
    ...
    (Tp.getLocalTransform = function (t, e) {
      Ip((e = e || []));
      var n = t.origin,
        i = t.scale || [1, 1],
        r = t.rotation || 0,
  ...
  var Tg = "undefined" != typeof window && !!window.addEventListener,
    ...
    Ng = {
      ...
      touchend: function (t) {
        ((t = rn(this.dom, t)).zrByTouch = !0),
          ...
          +new Date() - this._lastTouchMoment < 300 && Ng.click.call(this, t),
          dn(this);
      },
      ...
      pointermove: function (t) {
        fn(t) || Ng.mousemove.call(this, t);
      },
      pointerup: function (t) {
        Ng.mouseup.call(this, t);
      },
      pointerout: function (t) {
        fn(t) || Ng.mouseout.call(this, t);
      },
    };
  d(
  ...
  (Em.prototype = {
    ...
    getBoundingRect: function () {
      (Mm[0] = Mm[1] = Cm[0] = Cm[1] = Number.MAX_VALUE),
        (Im[0] = Im[1] = Tm[0] = Tm[1] = -Number.MAX_VALUE);
      for (
        ...
        switch ((1 == o && ((i = e = t[o]), (r = n = t[o + 1])), a)) {
          case Sm.M:
            ...
            break;
          case Sm.L:
            ei(e, n, t[o], t[o + 1], Cm, Tm), (e = t[o++]), (n = t[o++]);
            break;
          case Sm.C:
            ni(e, n, t[o++], t[o++], t[o++], t[o++], t[o], t[o + 1], Cm, Tm),
              (e = t[o++]),
              (n = t[o++]);
            break;
          case Sm.Q:
            ii(e, n, t[o++], t[o++], t[o], t[o + 1], Cm, Tm),
              (e = t[o++]),
              (n = t[o++]);
            break;
          case Sm.A:
    ...
    Av = (Object.freeze || Object)({
      ...
      clipRectByRect: function (t, e) {
        var n = Cv(t.x, e.x),
          ...
          r = Cv(t.y, e.y),
          o = Tv(t.y + t.height, e.y + e.height);
        if (i >= n && o >= r)
    ...
    zy = {
      ...
      getFormattedLabel: function (t, e, n, i, r) {
        ...
        return "function" == typeof l
          ? ((s.status = e), l(s))
          : "string" == typeof l
          ? Rr(l, s).replace(Oy, function (e, n) {
              var i = n.length;
              return (
                "[" === n.charAt(0) &&
                  "]" === n.charAt(i - 1) &&
  ...
  var sx = P,
    ...
    yx = "__optionUpdated",
    xx = /^[a-zA-Z0-9_]+$/;
  (Ta.prototype.on = Ca("on")),
    (Ta.prototype.off = Ca("off")),
    (Ta.prototype.one = Ca("one")),
    u(Ta, xp);
  var _x = Da.prototype;
  ...
  (_x._initEvents = function () {
    ...
    (_x.dispose = function () {
      if (!this._disposed) {
        (this._disposed = !0), Pn(this.getDom(), Rx, "");
        var t = this._api,
          e = this._model;
  ...
  es(2e3, Yy),
    ...
    Ja({ type: "highlight", event: "highlight", update: "highlight" }, N),
    Ja({ type: "downplay", event: "downplay", update: "downplay" }, N),
    $a("light", rx),
    $a("dark", ax);
  var Vx = {};
  hs.prototype = {
  ...
  var Fx = R(["tooltip", "label", "itemName", "itemId", "seriesName"]),
    Hx = w,
  ...
  (qx.type = "list"),
    ...
    (qx.initData = function (t, e, n) {
      ($r.isInstance(t) || c(t)) && (t = new No(t, this.dimensions.length)),
        (this._rawData = t),
        (this._storage = {}),
        (this._indices = null),
        (this._nameList = e || []),
  ...
  var N_ = cl.prototype;
  (N_._createSymbol = function (t, e, n, i) {
    this.removeAll();
    ...
    (N_.stopSymbolAnimation = function (t) {
      this.childAt(0).stopAnimation(t);
    }),
    (N_.getSymbolPath = function () {
      return this.childAt(0);
    }),
    (N_.getScale = function () {
      return this.childAt(0).scale;
    }),
    (N_.highlight = function () {
      this.childAt(0).trigger("emphasis");
    }),
    (N_.downplay = function () {
      this.childAt(0).trigger("normal");
    }),
    (N_.setZ = function (t, e) {
      var n = this.childAt(0);
      (n.zlevel = t), (n.z = e);
    }),
    (N_.setDraggable = function (t) {
      var e = this.childAt(0);
      (e.draggable = t), (e.cursor = t ? "move" : "pointer");
    }),
    (N_.updateData = function (t, e, n) {
      this.silent = !1;
  ...
  var B_ = ["itemStyle"],
    ...
    F_ = ["label"],
    H_ = ["emphasis", "label"];
  (N_._updateCommon = function (t, e, n, i) {
    ...
    Q_ = xi.extend({
      ...
      buildPath: function (t, e) {
        var n = e.points,
          ...
          o = n.length,
          a = e.smoothMonotone,
          s = Cl(n, e.smoothConstraint),
          l = Cl(i, e.smoothConstraint);
        if (e.connectNulls) {
          for (; o > 0 && wl(n[o - 1]); o--);
          for (; r < o && wl(n[r]); r++);
        }
    ...
    render: function (t, e, n) {
      ...
      if (f && c.type === i.type && S === this._step) {
        ...
        g.setClipPath(M),
          ...
          (Tl(this._stackedOnPoints, x) && Tl(this._points, h)) ||
            (m
  ...
  (iw.prototype = {
    ...
    getAxes: function () {
      return f(this._dimList, Rl, this);
    },
  ...
  (Gl.create = function (t, e) {
    ...
    (Gl.dimensions = Gl.prototype.dimensions = Nl.prototype.dimensions),
      ...
      _splitArea: function (t, e, n) {
        ...
        if (!i.scale.isBlank()) {
          ...
          for (
            ...
            if (!(Cw(i, x, p, h.length, m, v) && x < h.length - 1)) {
              var _,
                w,
                b,
                S,
    ...
    Bw = as({
      ...
      getDataParams: function (t) {
        ...
        return (
          ...
          (n.percent = Cr(i, t, e.hostModel.get("percentPrecision"))),
          n.$vars.push("percent"),
          n
        );
      },
  ...
  var Fw = function (t, e, n, i) {
      ...
      a.each(function (n) {
        ...
        !l && t.get("avoidLabelOverlap") && Th(s, r, o, e, n, i);
    },
    Hw = 2 * Math.PI,
    Gw = Math.PI / 180;
  !(function (t, e) {
            ...
            if (S <= 0.001) {
              ...
              e.each(i, function (t, n) {
                if (!isNaN(t)) {
                  ...
                  (i.angle = T),
                    (i.startAngle = f + C * n * T),
                    (i.endAngle = f + C * (n + 1) * T);
                }
              });
            } else
              (v = S / M),
  ...
  os({
    ...
    _showTooltipContent: function (t, e, n, i, r, o, a, s) {
      if (((this._ticket = ""), t.get("showContent") && t.get("show"))) {
        ...
        a = a || t.get("position");
        var u = e;
        if (h && "string" == typeof h) u = Rr(h, n, !0);
  ...
  Ja("legendToggleSelect", "legendselectchanged", v(Cu, "toggleSelected")),
    Ja("legendSelect", "legendselected", v(Cu, "select")),
    Ja("legendUnSelect", "legendunselected", v(Cu, "unSelect"));
  var db = v,
    fb = d,
    pb = Jp,
    gb = os({
  ...
  var Mb = l,
    Ib = v,
    Cb = { min: Ib(Ru, "min"), max: Ib(Ru, "max"), average: Ib(Ru, "average") },
    Tb = os({
      type: "marker",
      init: function () {
  ...
  (Lb.beforeUpdate = function () {
    ...
    (Lb._updateCommonStl = function (t, e, n) {
      ...
      if (v || y) {
        ...
        m = T(i.getFormattedLabel(e, "emphasis", t.dataType), g);
      }
      if (v) {
  ...
  var Nb = ["cartesian2d", "polar", "singleAxis"],
    Bb = (function (t, e) {
  ...
  var OS = {
    ...
    zS = {
      ...
      polygon: {
        ...
        updateCoverShape: function (t, e, n, i) {
          e.childAt(0).setShape({ points: Nd(t, e, n) });
        },
        updateCommon: Dd,
        contain: Hd,
      },
  ...
  (HS.setOutputRanges = function (t, e) {
    ...
    (HS.controlSeries = function (t, e, n) {
      ...
      return !0 === i || (i && NS(i.coordSyses, e.coordinateSystem) >= 0);
    }),
      ...
      grid: function (t, e) {
        ...
        (n || i || r) &&
          ...
          o.each(function (t) {
            var r = t.coordinateSystem,
              o = [];
            RS(r.getCartesians(), function (t, e) {
              (NS(n, t.getAxis("x").model) >= 0 ||
                NS(i, t.getAxis("y").model) >= 0) &&
                o.push(t);
            }),
              e.push({
                panelId: "grid--" + t.id,
  ...
  if (!Kf.canvasSupported) {
      ...
      if (r) {
        ...
        if (
          ...
          var M = [h, u],
            ...
            C = [h, u + d],
            T = [h + c, u + d];
          $(M, M, x), $(I, I, x), $(C, C, x), $(T, T, x);
          var D = dM(M[0], I[0], C[0], T[0]),
            A = dM(M[1], I[1], C[1], T[1]),
            k = [];
          k.push(
            "M11=",
            x[0] / b,
        ...
        if (v) {
          ...
          L ||
            ...
            (this._cropEl = L));
          var R = L.style;
          (R.width = sM((c + (g * c) / f) * b)),
            (R.height = sM((d + (m * d) / p) * S)),
            (R.filter =
    ...
    for (
      var EM = new Xt(), RM = [Sg, Xe, je, xi, ov], NM = 0;
      NM < RM.length;
      NM++
    ) {
      var BM = RM[NM].prototype;
          ...
          v && i
            ? ($(C, C, v),
              ...
              (S.matrix =
                ...
                v[3].toFixed(3) +
                ",0,0"),
              (S.offset = (sM(C[0]) || 0) + "," + (sM(C[1]) || 0)),
              (S.origin = "0 0"),
              (T.left = "0px"),
              (T.top = "0px"))
            : ((S.on = !1), (T.left = sM(c) + "px"), (T.top = sM(d) + "px")),
            (b.string = mM(o));
          try {
            b.style.font = m;
          } catch (t) {}
          CM(I, "fill", { fill: r.textFill, opacity: r.opacity }, this),
            CM(
              I,
              "stroke",
              {
  ...
  KM.brush = function (t) {
    ...
    if ((n instanceof HTMLImageElement && (n = n.src), n)) {
      ...
      s || ((s = _f("image")), (t.__svgEl = s)),
        n !== t.__imageSrc && (Tf(s, "href", n), (t.__imageSrc = n)),
        Cf(s, "width", o),
        Cf(s, "height", a),
        Cf(s, "x", i),
        Cf(s, "y", r),
  ...
  var QM = {},
    ...
    tI = function (t, e, n) {
      ...
      if (null != r) {
        ...
        Cf(o, "alignment-baseline", d), c && (o.style.font = c);
        var g = i.textPadding;
        if (
          (Cf(o, "x", a),
          Cf(o, "y", s),
  ...
  (zf.prototype.createElement = _f),
    ...
    h(Rf, zf),
    (Rf.prototype.update = function (t) {
    ...
    (Rf.prototype.updateDom = function (t, e, n) {
      if (e && e.length > 0) {
        var i,
          r,
          o = this.getDefs(!0),
    ...
    h(Nf, zf),
    (Nf.prototype.addWithoutUpdate = function (t, e) {
      if (e && Bf(e.style)) {
        var n,
          i = e.style;
        i._shadowDom
    ...
    (Nf.prototype.update = function (t, e) {
      var n = e.style;
      if (Bf(n)) {
        var i = this;
    ...
    (Nf.prototype.remove = function (t, e) {
      null != e._shadowDomId && (this.removeDom(e), (t.style.filter = ""));
    }),
    (Nf.prototype.updateDom = function (t, e) {
  ...
  var iI = function (t, e, n, i) {
    ...
    r.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
      ...
      (this.clipPathManager = new Rf(i, r)),
      (this.shadowManager = new Nf(i, r));
  ...
  (iI.prototype = {
    ...
    (t.init = function (t, e, n) {
      ...
      if (i) return i;
      var r = new Da(t, e, n);
      return (r.id = "ec_" + zx++), (Lx[r.id] = r), Pn(t, Rx, r.id), ja(r), r;
    }),
