...
(function ($) {
    ...
    switch (that.options.cookieStorage) {
      case "cookieStorage":
        document.cookie = [
          ...
          that.options.cookieDomain
            ? "; domain=" + that.options.cookieDomain
            : "",
  ...
  var initCookieFilters = function (bootstrapTable) {
    setTimeout(function () {
      var parsedCookieFilters = JSON.parse(
        getCookie(
          bootstrapTable,
      ...
      if (
        !bootstrapTable.options.filterControlValuesLoaded &&
        parsedCookieFilters
      ) {
        var cachedFilters = {},
  ...
  BootstrapTable.prototype.init = function () {
    ...
    this.options.cookiesEnabled =
      typeof this.options.cookiesEnabled === "string"
        ? this.options.cookiesEnabled
            .replace("[", "")
            .replace("]", "")
            .replace(/ /g, "")
  ...
  BootstrapTable.prototype.initServer = function () {
    ...
    if (
      bootstrapTable.options.cookie &&
      bootstrapTable.options.filterControl &&
      !bootstrapTable.options.filterControlValuesLoaded
    ) {
  ...
  BootstrapTable.prototype.initCookie = function () {
    ...
    var sortOrderCookie = getCookie(
        this,
        this.options.cookieIdTable,
        cookieIds.sortOrder
      ),
      sortOrderNameCookie = getCookie(
        this,
        this.options.cookieIdTable,
        cookieIds.sortName
      ),
      pageNumberCookie = getCookie(
        this,
        this.options.cookieIdTable,
        cookieIds.pageNumber
      ),
      pageListCookie = getCookie(
        this,
        this.options.cookieIdTable,
        cookieIds.pageList
      ),
      columnsCookie = JSON.parse(
        getCookie(this, this.options.cookieIdTable, cookieIds.columns)
      ),
      searchTextCookie = getCookie(
        this,
        this.options.cookieIdTable,
    ...
    //sortOrder
    this.options.sortOrder = sortOrderCookie
      ? sortOrderCookie
      : this.options.sortOrder;
    //sortName
    this.options.sortName = sortOrderNameCookie
      ? sortOrderNameCookie
      : this.options.sortName;
    //pageNumber
    this.options.pageNumber = pageNumberCookie
      ? +pageNumberCookie
