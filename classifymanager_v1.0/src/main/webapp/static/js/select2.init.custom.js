...
function loadSelect2EntityData(){
	$(".select-entity-data-array").select2({
...
function loadSelect2ApiData(){
	$(".select-api-data-array").select2({
...
function loadSelect2IntentData(){
	$(".select-intent-data-array").select2({
	  placeholder: "Select 대화명",
	  allowClear: true,
	  data: intentData
	});
}
...
function loadSelect2ScenarioData(){
	$(".select-scenario-data-array").select2({
	  placeholder: "Select 시나리오",
	  allowClear: true,
	  data: scenarioData
	});
}
